  ...
  expo: {
    ...
    plugins: [
      ...
      [
        ...
        {
          android: {
            // R8 is what produces the deobfuscation mapping. Without it Play warns
            // "no deobfuscation file associated with this App Bundle" and production
            // crash/ANR stack traces arrive unreadable. AGP embeds the mapping into
            // the .aab automatically, so nothing extra has to be uploaded.
            enableMinifyInReleaseBuilds: true,
            // Left off on purpose: resource shrinking breaks lookups by name and is
            // not needed for the mapping file.
            enableShrinkResourcesInReleaseBuilds: false,
            // android/ is gitignored and regenerated by prebuild, so keep rules have
            // to live here rather than in android/app/proguard-rules.pro.
            extraProguardRules: [
              "-keepattributes SourceFile,LineNumberTable",
              "-renamesourcefileattribute SourceFile",
              "",
              "# Reflection-based libraries: R8 cannot see these uses.",
              ...
              "",
              "# Firebase/GMS read annotations and model fields reflectively.",
