...
const createStyles = (theme: CustomTheme) =>
  StyleSheet.create({
    ...
    flexButton: { flex: 1, borderRadius: theme.custom.radius.md },
    ...
    deviceRow: { borderRadius: theme.custom.radius.sm },
    ...
    saveButton: { borderRadius: theme.custom.radius.md, marginTop: 4 },
    bigButton: { height: 52 },
  });
